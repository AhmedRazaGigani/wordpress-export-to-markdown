// get the venue's country from the associated venue post's metadata
module.exports = (post, allPosts) => {
    ...
    const venueCountryMeta = venuePost.data.postmeta.find(meta => meta.meta_key[0] === '_VenueCountry');
